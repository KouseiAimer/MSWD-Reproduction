"""Plot Model A rejection rates from the last 50 complete runs."""
...
DEFAULT_INPUT = BASE / "modelA_last50_summary.csv"
DEFAULT_OUTPUT = BASE / "Figure1_ModelA_last50.png"
...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="Plot Model A last-50 summary.")
